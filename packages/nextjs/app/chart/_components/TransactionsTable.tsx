  ...
  return (
    <div className="flex justify-center pr-8 ">
      <div className="overflow-x-auto w-full shadow-2xl rounded-xl">
        <table className="table text-xl w-full table-sm ">
          <thead>
            <tr className="rounded-xl text-sm text-base-content font-mono">
          ...
          <tbody>
            {blocks.map(block =>
              (block.transactions as TransactionWithFunction[]).map(tx => {
                ...
                return (
                  <tr key={tx.hash} className="hover text-sm font-mono">
